  ...
  return (
    <>
      ...
      <div className="hidden lg:flex flex-col  inset-0 overflow-visible items-center justify-center ">
        <FlipStack cards={cards} />
        <button className="w-[140px] h-[58px] flex justify-center items-center p-4 bg-black text-white cursor-pointer rounded-3xl mt-8 border border-black hover:bg-white hover:text-black transition">
          Get Started
        </button>
      </div>
    </>
