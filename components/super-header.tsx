...
//             className="fixed inset-0 md:bg-black/20  transparent backdrop-blur-sm z-10"
//             onClick={() => setHovered(null)}
//           />
//         )}
//       </AnimatePresence>

//       <header className="relative z-20 flex justify-between items-center pl-10 pr-[10px] pt-[10px] pb-[10px] rounded-full md:bg-black/20  transparent backdrop-blur-md nav-container mx-auto mt-4">
//         {/* Logo */}
...
//                       className="fixed left-1/2 -translate-x-1/2 top-[80px] bg-white shadow-xl rounded-4xl p-3 flex gap-12 w-full max-w-[85rem] h-[400px] z-20"
//                     >
//                       {/* Left Image Card */}
//                       <motion.div
...
//                                         <span className="w-[70px] h-[70px] border-1 border-gray-200 rounded-2xl text-2xl flex-shrink-0 transition-transform group-hover:scale-110">{item.icon}</span>
//                                         <span>
...
//                 whileTap={{ scale: 0.98 }}
//                 className="px-4 py-3 rounded-full bg-orange-500 text-white font-semibold shadow-md hover:bg-orange-600 transition hidden md:inline-block "
//               >
//                 {link.label}
//               </motion.a>
...
//               //first do this hide the orange color button in mobile view then display  a hamburger menu button
//             ) : (
//               <a
//                 key={index}
//                 href={link.href}
