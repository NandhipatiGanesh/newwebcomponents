//File: components/ui/expandable-dock.tsx
"use client";
    ...
    <div className="fixed bottom-8 left-1/2 -translate-x-1/2 z-50 w-full px-4 sm:px-0">
      ...
      >
        <div
          ...
          className="flex items-center gap-4 px-4 sm:px-6 py-4 text-white w-full h-[68px] whitespace-nowrap cursor-pointer border-t border-gray-200 flex-shrink-0"
        >
          {headerContent}
        </div>
        <motion.div
